...
var ReactTags = function (_Component) {
  ...
  _createClass(ReactTags, [{
    ...
    key: 'handleTagKeyDown',
    value: function handleTagKeyDown(i, e) {
      ...
      if (e.keyCode === _constants.KEYS.BACKSPACE || e.keyCode === _constants.KEYS.DELETE) {
        if (i === tags.length - 1) {
          if (!this.props.resetInputOnDelete) {
            this.textInput && this.textInput.focus();
          } else {
      ...
      if (e.keyCode === _constants.KEYS.LEFT_ARROW && i > 0) {
      ...
      if (e.keyCode === _constants.KEYS.RIGHT_ARROW && i < tags.length - 1) {
        this.props.handleDrag(tags[i], i, i + 1);
        window.setTimeout(function () {
          document.getElementsByClassName('tag-wrapper')[i + 1].focus();
        }, 1);
...
ReactTags.propTypes = {
  ...
  handleTagKeyDown: _propTypes2.default.func,
  ...
  focusInputOnTagClick: _propTypes2.default.bool,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTagItems = function () {
    ...
    return tags.map(function (tag, index) {
      return _react2.default.createElement(_Tag2.default, {
        ...
        onClick: _this4.handleTagClick.bind(_this4, index),
        onKeyDown: _this4.handleTagKeyDown.bind(_this4, index),
        readOnly: readOnly,
  ...
  this.setTextInputRef = function (input) {
    _this4.textInput = input;
    if (_this4.props.textInputRef) {
      _this4.props.textInputRef(input);
    }
  };
};
